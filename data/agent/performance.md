...
_Generated 2026-07-26 08:15 UTC by `polymarket agent-report`. PAPER ONLY. See `strategy.md` for the playbook and `journal.md` for reasoning._
...
| free cash | $826.51 |
| open positions | 1 ($23.77 at risk) |
| settled | 38 (17 wins, 45%) |
| realized PnL | $-149.72 on $794.72 staked (-18.8%) |
...
|:---------|--:|-----:|---------:|--------:|-----:|----:|
| Climate and Weather | 38 | 17 | 45% | 794.72 | -149.72 | -18.8% |
